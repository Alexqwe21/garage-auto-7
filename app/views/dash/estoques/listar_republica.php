...
<form method="GET" class="row g-3 mb-4">
  ...
  <div class="col-md-2 d-flex align-items-end">
    <a href="<?= BASE_URL ?>/Estoques" class="btn btn-outline-secondary w-100">
      Limpar
    </a>
  </div>
...
<div class="mb-3 d-flex justify-content-between align-items-center">
  <h5 class="mb-0">Estoque - REPUBLICA</h5>
        ...
        <div class="modal fade" id="editarProduto<?= $produto['id_produto'] ?>" tabindex="-1">
          <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
              ...
              <form action="<?= BASE_URL ?>/Estoques/atualizar/<?= $produto['id_produto'] ?>" method="POST">
        ...
        <div class="modal fade" id="entradaProduto<?= $produto['id_produto'] ?>" tabindex="-1">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <form action="<?= BASE_URL ?>/Estoques/movimentarRepublica" method="POST">
...
<div class="modal fade" id="modalCadastrarEstoque" tabindex="-1">
  <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <form action="<?= BASE_URL ?>/Estoques/salvar" method="POST">

        
        <input type="hidden" name="id_estoque" value="2">
